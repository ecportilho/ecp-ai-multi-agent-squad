...
description: >
  Gerar diagrama de classes em Mermaid a partir do class-model.md com stereotypes DDD. Use após class-model-designer para produzir o diagrama renderizável no site de docs.
---
...
> ⚠️ Aplicar o tema dark com as cores da identidade visual do produto (conforme design_spec.md) — não usar o tema padrão branco.
