...
name: adr-writer
description: >
  Registrar Architecture Decision Records com contexto, decisão, consequências e status. Use sempre que uma decisão arquitetural for tomada ou alterada — toda decisão relevante precisa de ADR.
---
