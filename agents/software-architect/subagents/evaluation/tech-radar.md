...
name: tech-radar
description: >
  Avaliar adoção, trial, assess ou descontinuação de tecnologias além do framework base do squad. Use ao considerar qualquer tecnologia fora do stack padrão — toda adição precisa de posicionamento no radar.
---
