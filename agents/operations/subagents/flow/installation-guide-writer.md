---
name: installation-guide-writer
description: >
  Gerar guia de instalação completo do produto para novos desenvolvedores e ambientes. Use após o primeiro deploy bem-sucedido para documentar o setup do ambiente de desenvolvimento.
---
...
- [Localização do Output](#localização-do-output)
- [Princípios de Escrita](#princípios-de-escrita)
- [Estrutura Completa do Guia](#estrutura-completa-do-guia)
- [📋 Índice](#📋-índice)
- [1. Entendendo o que vamos instalar {#1-entendendo}](#1-entendendo-o-que-vamos-instalar-{#1-entendendo})
- [2. Preparando seu computador {#2-preparando}](#2-preparando-seu-computador-{#2-preparando})
- [3. Instalando o Node.js {#3-nodejs}](#3-instalando-o-node-js-{#3-nodejs})
- [4. Instalando o pnpm {#4-pnpm}](#4-instalando-o-pnpm-{#4-pnpm})
- [5. Baixando o código da aplicação {#5-codigo}](#5-baixando-o-código-da-aplicação-{#5-codigo})
- [6. Configurando o banco de dados (Supabase) {#6-supabase}](#6-configurando-o-banco-de-dados-supabase-{#6-supabase})
- [7. Configurando o cache (Upstash) {#7-upstash}](#7-configurando-o-cache-upstash-{#7-upstash})
- [8. Configurando as variáveis de ambiente {#8-env}](#8-configurando-as-variáveis-de-ambiente-{#8-env})
- [9. Instalando as dependências do projeto {#9-dependencias}](#9-instalando-as-dependências-do-projeto-{#9-dependencias})
- [10. Preparando o banco de dados {#10-banco}](#10-preparando-o-banco-de-dados-{#10-banco})
- [11. Rodando a aplicação localmente {#11-rodando}](#11-rodando-a-aplicação-localmente-{#11-rodando})
- [12. Verificando se tudo está funcionando {#12-verificando}](#12-verificando-se-tudo-está-funcionando-{#12-verificando})
- [13. Fazendo o deploy {#13-deploy}](#13-fazendo-o-deploy-{#13-deploy})
- [14. O que fazer se algo der errado {#14-erros}](#14-o-que-fazer-se-algo-der-errado-{#14-erros})
- [🎉 Parabéns!](#🎉-parabéns)
- [Instruções para o Agente](#instruções-para-o-agente)
- [Output](#output)

> **Este arquivo tem 700+ linhas.** Use o índice acima para navegar diretamente à seção relevante.
