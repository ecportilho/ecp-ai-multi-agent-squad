...
description: >
  Definir e executar estratégia de deploy para web (Vercel) e mobile (EAS) com feature flags e rollback. Use ao planejar o primeiro deploy, ao configurar estratégia de release, ou ao implementar rollout gradual.
---
