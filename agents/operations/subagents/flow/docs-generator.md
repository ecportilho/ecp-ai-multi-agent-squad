...
name: docs-generator
description: >
  Gerar site de documentação navegável em {REPO_DESTINO}/docs/ consolidando artefatos das 4 fases. Use após aprovação do HITL #12 para criar a documentação final do produto.
---
...
Seguir a identidade visual do produto (conforme design_spec.md): `{REPO_DESTINO}/design_spec.md`
