...
description: >
  Configurar observabilidade completa com Sentry (erros), New Relic (APM) e PostHog (produto). Use ao iniciar a Fase 04, ao adicionar novos serviços que precisam de monitoramento, ou ao revisar cobertura de observabilidade.
---
