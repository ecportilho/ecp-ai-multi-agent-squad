...
description: >
  Definir SLOs realistas, SLIs mensuráveis e error budgets para o produto em produção. Use antes do primeiro deploy para estabelecer os contratos de confiabilidade do serviço.
---
