...
description: >
  Gerar dashboard HTML standalone com Chart.js e identidade visual do design_spec.md para métricas de produto e SRE. Use após o primeiro deploy em produção para criar o painel operacional com as 4 seções: Visão Geral, Uso do Produto, Outcomes & KRs e SRE Técnico.
---

## Índice de Seções

- [Objetivo](#objetivo)
- [Referência Visual Obrigatória](#referência-visual-obrigatória)
- [Localização do Output](#localização-do-output)
- [Estrutura do Dashboard](#estrutura-do-dashboard)
- [Template HTML Completo](#template-html-completo)
- [assets/style.css](#assets-style-css)
- [assets/data.js](#assets-data-js)
- [assets/charts.js](#assets-charts-js)
- [README.md (instruções de integração)](#readme-md-instruções-de-integração)
- [Modo Atual: Dados Simulados](#modo-atual-dados-simulados)
- [Integrações por Fonte](#integrações-por-fonte)
- [Checklist de Qualidade do Dashboard](#checklist-de-qualidade-do-dashboard)

> **Este arquivo tem 1.000+ linhas.** Use o índice acima para navegar diretamente à seção relevante.
...
## Objetivo
Gerar o arquivo HTML do dashboard operacional — standalone, sem servidor, com identidade visual do produto (conforme design_spec.md) — integrando métricas de produto e SRE em uma interface clara e navegável.
...
- [ ] Identidade visual do produto (conforme design_spec.md) fiel (dark + lime)
