...
## Identidade Visual
Seguir obrigatoriamente a identidade o produto (conforme design_spec.md):
- `{REPO_DESTINO}/design_spec.md`
- `{REPO_DESTINO}/design_spec.md (protótipo de referência)`
- Tema: Dark + Verde-limão (`#b7ff2a`)

## Skills

| Skill | Arquivo | Responsabilidade |
|-------|---------|-----------------|
| `dashboard-builder` | `dashboard-builder.md` | Gera o HTML do dashboard com identidade o produto (conforme design_spec.md) |
...
├── assets/
│   ├── style.css       # Identidade o produto (conforme design_spec.md)
...
- Identidade o produto (conforme design_spec.md) aplicada fielmente em todos os componentes
