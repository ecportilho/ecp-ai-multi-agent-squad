...
description: >
  Mapear e priorizar suposições críticas por risco (valor, usabilidade, viabilidade, negócio). Use após definir hipóteses de solução para identificar o que precisa ser validado primeiro.
---
