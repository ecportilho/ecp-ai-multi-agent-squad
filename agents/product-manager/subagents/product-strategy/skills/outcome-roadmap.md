...
description: >
  Construir roadmap de outcomes orientado a KRs — sem datas fixas de feature, com now/next/later. Use ao comunicar estratégia de produto para stakeholders sem comprometer com soluções específicas.
---
