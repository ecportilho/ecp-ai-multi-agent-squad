...
description: >
  Separar métricas preditivas (leading) de métricas de resultado (lagging) e definir relações causais. Use ao estruturar o conjunto de métricas do produto para garantir que o time mede o que importa.
---
