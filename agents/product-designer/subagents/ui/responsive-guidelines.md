...
description: >
  Definir breakpoints e comportamento responsivo por plataforma baseado no design_spec.md. Use ao especificar layout adaptativo para mobile, tablet e desktop antes da implementação.
---
