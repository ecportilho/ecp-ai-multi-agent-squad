...
name: component-spec
description: >
  Especificar componentes de UI (botões, cards, inputs, modais) com variantes, estados e tokens do design_spec. Use ao definir novos componentes do design system antes da implementação pelo Front End.
---
