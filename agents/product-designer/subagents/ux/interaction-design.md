...
description: >
  Especificar microinterações, animações e estados de transição do produto. Use ao detalhar comportamentos interativos complexos que o high-fi deve implementar.
---
