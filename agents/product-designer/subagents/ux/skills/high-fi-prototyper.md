---
name: high-fi-prototyper
description: >
  Criar protótipo HTML navegável de alta fidelidade com identidade visual do design_spec.md para validação de usabilidade. Use na Fase 02 após aprovação do low-fi — produz o high-fi.html que será referência visual para o Front End.
---
