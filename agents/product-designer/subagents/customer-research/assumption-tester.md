...
description: >
  Testar suposições críticas com usuários reais e personas sintéticas antes de prototipar. Use antes de iniciar qualquer prototipação — validar suposições economiza tempo de design.
---
