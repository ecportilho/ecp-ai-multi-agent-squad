...
description: >
  Escrever testes unitários de componentes React e hooks com Vitest e React Testing Library. Use ao criar componentes com lógica de UI, hooks customizados, ou utils de formatação.
---
