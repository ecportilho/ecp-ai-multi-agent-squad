...
description: >
  Implementar gerenciamento de estado com Zustand e cache de servidor via tRPC hooks. Use ao criar estado global de sessão, carrinho, ou qualquer dado compartilhado entre rotas.
---
