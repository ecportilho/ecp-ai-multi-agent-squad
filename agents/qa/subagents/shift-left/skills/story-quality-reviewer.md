...
description: >
  Revisar histórias antes do desenvolvimento: cobertura de ACs, RNs explícitas, campos mapeados. Use antes de qualquer história entrar em sprint — emite parecer de aprovação ou lista de gaps.
---
