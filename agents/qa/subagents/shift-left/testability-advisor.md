...
description: >
  Orientar design de código para testabilidade: injeção de dependência, interfaces, separação de responsabilidades. Use ao revisar arquitetura de services ou ao identificar código difícil de testar.
---
