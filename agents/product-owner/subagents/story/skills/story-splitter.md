...
name: story-splitter
description: >
  Dividir histórias grandes (> 5 pontos ou violando INVEST) em histórias menores e independentes. Use sempre que uma história não couber em 1 sprint ou tiver múltiplos objetivos distintos.
---
