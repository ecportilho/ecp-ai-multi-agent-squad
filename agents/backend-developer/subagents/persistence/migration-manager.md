...
description: >
  Gerenciar migrations Drizzle: gerar, revisar e aplicar com segurança. Use sempre que o schema de banco mudar — nunca alterar schema sem migration versionada.
---
