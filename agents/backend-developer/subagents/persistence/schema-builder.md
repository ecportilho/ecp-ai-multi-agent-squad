...
name: schema-builder
description: >
  Construir schema Drizzle a partir do modelo de classes do Arquiteto com tipos corretos e constraints. Use ao iniciar o schema de banco ou ao adicionar novas tabelas — sempre após o data-modeling do Arquiteto.
---
