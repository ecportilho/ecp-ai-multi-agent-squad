...
description: >
  Escrever testes unitários para services e domain com Vitest, cobrindo todos os casos de teste do Mapa Three Amigos com rastreabilidade direta a cada AC. Use ao implementar ou modificar qualquer service de domínio — testes escritos junto com o código, não depois.
---
