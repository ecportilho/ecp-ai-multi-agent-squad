...
description: >
  Verificar conformidade da implementação com contratos Zod/tRPC definidos pelo Arquiteto. Use após qualquer implementação de router ou service, ou antes de cada HITL de backend.
---
