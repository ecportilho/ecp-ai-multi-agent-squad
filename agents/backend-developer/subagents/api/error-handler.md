...
name: error-handler
description: >
  Implementar sistema padronizado de erros com AppError e ErrorCode mapeados para TRPCError. Use ao criar novos domínios de erro, ao adicionar códigos de erro específicos de negócio, ou ao revisar tratamento de erros existente.
---
