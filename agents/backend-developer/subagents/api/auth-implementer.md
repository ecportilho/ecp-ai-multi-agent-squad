...
description: >
  Implementar autenticação Supabase Auth e proteger procedures tRPC com middleware de contexto. Use ao criar fluxos de registro, login, sessão ou proteção de rotas — web e mobile.
---
